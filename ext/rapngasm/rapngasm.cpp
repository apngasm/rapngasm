...
void Init_rapngasm()
{
  ...
  typedef size_t (APNGAsm::*add_frame_rgba)(rgba*, unsigned int, unsigned int, unsigned, unsigned);
    ...
    .define_method("set_loops", &APNGAsm::setLoops, Arg("loops") = 0)
    .define_method("set_skip_first", &APNGAsm::setSkipFirst, Arg("skip_first"))
    .define_method("get_loops", &APNGAsm::getLoops)
    .define_method("is_skip_first", &APNGAsm::isSkipFirst)
